...
namespace ChatProvider.Models
{
    ...
    public class CreateAreaRequest : IEquatable<CreateAreaRequest>, ICreateAreaRequest, ICreateAreaRequest2
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CreateAreaRequest)obj);
        }

        /// <summary>
        /// Returns true if CreateAreaRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateAreaRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAreaRequest other)
        {

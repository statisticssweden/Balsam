...
namespace GitProviderApiClient.Api
{
    ...
    public partial class UserApi : IUserApi
    {
        ...
        /// <returns></returns>
        public UserApi(GitProviderApiClient.Client.Configuration configuration)
        {
        ...
        public UserApi(GitProviderApiClient.Client.ISynchronousClient client, GitProviderApiClient.Client.IAsynchronousClient asyncClient, GitProviderApiClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            GitProviderApiClient.Client.ApiResponse<UserPATCreatedResponse> localVarResponse = CreatePATWithHttpInfo(id);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserPATCreatedResponse</returns>
        public GitProviderApiClient.Client.ApiResponse<UserPATCreatedResponse> CreatePATWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new GitProviderApiClient.Client.ApiException(400, "Missing required parameter 'id' when calling UserApi->CreatePAT");
            }
            ...
            localVarRequestOptions.PathParameters.Add("id", GitProviderApiClient.Client.ClientUtils.ParameterToString(id)); // path parameter
        ...
        {
            GitProviderApiClient.Client.ApiResponse<UserPATCreatedResponse> localVarResponse = await CreatePATWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserPATCreatedResponse)</returns>
        public async System.Threading.Tasks.Task<GitProviderApiClient.Client.ApiResponse<UserPATCreatedResponse>> CreatePATWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {

...
namespace GitProviderApiClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "http://git-provider.balsam-system.svc.cluster.local/api/v1";
        ...
        public Configuration(
            ...
            string basePath = "http://git-provider.balsam-system.svc.cluster.local/api/v1") : this()
        {
        ...
        {
            string report = "C# SDK (GitProviderApiClient) Debug Report:\n";

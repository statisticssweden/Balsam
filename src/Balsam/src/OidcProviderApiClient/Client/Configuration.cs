...
namespace OidcProviderApiClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "http://oidc-provider.balsam-system.svc.cluster.local/api/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "http://oidc-provider.balsam-system.svc.cluster.local/api/v1"},
        ...
        public Configuration(
            ...
            string basePath = "http://oidc-provider.balsam-system.svc.cluster.local/api/v1") : this()
        {
        ...
        {
            string report = "C# SDK (OidcProviderApiClient) Debug Report:\n";

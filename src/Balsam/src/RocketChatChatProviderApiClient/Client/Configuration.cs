...
namespace RocketChatChatProviderApiClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "http://chat-provider.balsam-system.svc.cluster.local/api/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "http://chat-provider.balsam-system.svc.cluster.local/api/v1"},
        ...
        public Configuration(
            ...
            string basePath = "http://chat-provider.balsam-system.svc.cluster.local/api/v1") : this()
        {
        ...
        {
            string report = "C# SDK (RocketChatChatProviderApiClient) Debug Report:\n";
